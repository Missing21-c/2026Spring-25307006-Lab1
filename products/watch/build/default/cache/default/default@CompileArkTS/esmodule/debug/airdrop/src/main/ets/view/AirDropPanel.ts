...
import { AirDropViewModel } from "@bundle:com.huawei.music.musichome/watch@airdrop/ets/viewmodel/AirDropViewModel";
import type { DeviceInfo, MusicInfo, TransferProgress } from '../viewmodel/AirDropModels';
import { AirDropMessages } from "@bundle:com.huawei.music.musichome/watch@airdrop/ets/constants/AirDropConstants";
                        ...
                        const forEachItemGenFunction = _item => {
                            const device = _item;
                            {
                                ...
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        // 设备图标
                                        Image.create({ "id": 184549737, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "watch" });
                                        // 设备图标
                                        Image.width(40);
                                        // 设备图标
                                        Image.height(40);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (this.selectedDevice?.deviceId === device.deviceId) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Image.create({ "id": 184549673, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "watch" });
                                                    Image.width(24);
                                                    Image.height(24);
