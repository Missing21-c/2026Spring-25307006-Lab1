...
import { LocalMusicService, FilePickerService } from "@bundle:com.huawei.music.musichome/phone@mediacommon/index";
import type { LocalFile, FileObject } from "@bundle:com.huawei.music.musichome/phone@mediacommon/index";
import { FilePickerComponent, ButtonStyle } from "@bundle:com.huawei.music.musichome/phone@musiclist/ets/components/FilePickerComponent";
import abilityAccessCtrl from "@ohos:abilityAccessCtrl";
import type { Permissions } from "@ohos:abilityAccessCtrl";
import type common from "@ohos:app.ability.common";
import { AirDropViewModel } from "@bundle:com.huawei.music.musichome/phone@airdrop/Index";
export class LocalFileListComponent extends ViewPU {
    ...
    FileItem(file: LocalFile, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 播放按钮
            Image.create(this.currentPlayingPath === file.path ? { "id": 150995347, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" } : { "id": 150995348, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            // 播放按钮
            Image.width(24);
            // 播放按钮
            Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 删除按钮
            Image.create({ "id": 150995319, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            // 删除按钮
            Image.width(20);
            // 删除按钮
            Image.height(20);
