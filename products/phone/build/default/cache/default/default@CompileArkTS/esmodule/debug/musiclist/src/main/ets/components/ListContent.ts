...
export class Content extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridCol.backgroundColor({ "id": 150995131, "type": 10001, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
        }, GridCol);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            __Common__.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridCol.borderRadius({ "id": 150995272, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
        }, GridCol);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            __Common__.create();
            __Common__.padding({
